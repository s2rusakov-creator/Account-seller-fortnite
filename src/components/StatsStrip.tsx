...
export function StatsStrip({
  ...
  return (
    <section className="card">
      ...
      {locker.unplayed && (
        <p className="facts">
          <b>Аккаунт ни разу не запускали в игру.</b> Epic закрывает раздевалку до первого входа,
          но у такого аккаунта её и нет: показан стартовый набор, одинаковый у всех новых
          аккаунтов, уровень нулевой, В-Баксов нет. Если на аккаунте что-то всё же есть — войдите
          в Fortnite один раз и прочитайте заново.
        </p>
      )}
